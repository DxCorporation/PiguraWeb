...
<body>
    ...
    <section id="hero">
        <div class="hero-container">
            <a href="index.html" class="hero-logo" data-aos="zoom-in"><img src="user/img/piguralogo.png"
                    alt=""></a>
            <h1 data-aos="zoom-in">Ridwan Pigura</h1>
            <h2 data-aos="fade-up">Kami Memberikan Sentuhan Elegan Pada Setiap Cerita</h2>
            <small data-aos="fade-up" class="mb-4">Jl. Anggrek Jl. Sagan No.20, Sagan, Caturtunggal, Depok,Sleman,
                Yogyakarta</small>
            <a data-aos="fade-up" data-aos-delay="200" href="{{ url('/') }}#about" class=" scrollto"><svg
